                  ...
                  <div class="carousel-item active">
                    <div class="banner_bg">
                      <div class="banner_taital_main">
                        ...
                        <div class="btn_main">
                          <div class="about_us"><a href="about.jsp">About Us</a></div>
                          <div class="about_bt"><a href="appoint.jsp">Get Appointment</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="appointment_bt_main">
                <div class="appointment_bt"><a href="appoint.jsp">Get Appointment</a></div>
              </div>
            </div>
          </div>
        </div>
